...
export const Item = ({
  ...
  const onCreate = (
    ...
    const promise = create({
      title: "Untitled", parentDocuemnt: id
    })
    .then((documentId) => {
      if (!expanded) {
        onExpand?.();
  ...
  return (
    <div
      ...
      className={cn("group min-h-[27px] text-sm y-1 pr-3 w-full hover:bg-primary/5 flex items-center text-muted-foreground font-medium",
